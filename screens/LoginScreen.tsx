...
const ForgotPasswordForm: React.FC<{ onSwitchView: (view: 'login') => void; }> = ({ onSwitchView }) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (result.success) {
                setMessage('Se este e-mail estiver cadastrado em nosso sistema, você receberá em breve uma mensagem com as instruções para redefinir sua senha. Verifique sua caixa de entrada e também a pasta de spam!');
            } else {
    ...
    return (
        <>
            <div className="text-center space-y-4">
                <LockIcon className="w-16 h-16 mx-auto text-dark-primary" />
